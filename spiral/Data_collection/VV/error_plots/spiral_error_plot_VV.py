...
def error_plot_VV(r0,h):
    ...
    points_be2 = [vv_NDC.energy_errors,
                  ...
                  vv_DC_VarT.energy_errors,
                  vv_FIRE.energy_errors]
    ...
    axes.legend(bbox_to_anchor=(0.46, 0.25), loc=2, borderaxespad=0.0,
                frameon=False)


    plt.savefig('spiral_error_plot_VV.png', bbox_inches='tight')
