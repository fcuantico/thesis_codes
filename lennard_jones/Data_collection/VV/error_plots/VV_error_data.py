...
class VV_Error_Data_Collection():
    ...
    def __init__(self,initial_point):
        ...
        if vv_NDC_data.steps < 1000:
            conv = 'Yes'
            #--
            f_norm = vv_NDC_data.energy_errors[-1][0]
        ...
        if vv_DC_NVT_data.steps < 1000:
            conv = 'Yes'
            #--
            f_norm = vv_DC_NVT_data.energy_errors[-1][0]
        ...
        if vv_DC_VarT_data.steps < 1000:
            conv = 'Yes'
            #--
            f_norm = vv_DC_VarT_data.energy_errors[-1][0]
        ...
        if vv_FIRE_data.steps < 1000:
            conv = 'Yes'
            #--
            f_norm = vv_FIRE_data.energy_errors[-1][0]
