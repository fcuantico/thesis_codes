...
class NSTOVSUT_Error_Data_Collection():
    ...
    def __init__(self,initial_point):
        ...
        if nstovsut_NDC_data.steps < 1000:
            conv = 'Yes'
            #--
            f_norm = nstovsut_NDC_data.energy_errors[-1][0]
        ...
        if nstovsut_DC_NVT_data.steps < 1000:
            conv = 'Yes'
            #--
            f_norm = nstovsut_DC_NVT_data.energy_errors[-1][0]
        ...
        if nstovsut_DC_VarT_data.steps < 1000:
            conv = 'Yes'
            #--
            f_norm = nstovsut_DC_VarT_data.energy_errors[-1][0]
        ...
        if nstovsut_FIRE_data.steps < 1000:
            conv = 'Yes'
            #--
            f_norm = nstovsut_FIRE_data.energy_errors[-1][0]
