...
class BE2_Error_Data_Collection():
    ...
    def __init__(self,initial_point):
        ...
        if be2_NDC_data.steps < 1000:
            conv = 'Yes'
            #--
            f_norm = be2_NDC_data.energy_errors[-1][0]
        ...
        if be2_DC_NVT_data.steps < 1000:
            conv = 'Yes'
            #--
            f_norm = be2_DC_NVT_data.energy_errors[-1][0]
        ...
        if be2_DC_VarT_data.steps < 1000:
            conv = 'Yes'
            #--
            f_norm = be2_DC_VarT_data.energy_errors[-1][0]
        ...
        if be2_FIRE_data.steps < 1000:
            conv = 'Yes'
            #--
            f_norm = be2_FIRE_data.energy_errors[-1][0]
