...
def error_plot_BE2(r0,h):
    ...
    #-----------------------------------------------------------------------
    # BE2 points
    points_be2 = [be2_NDC.norm_forces,
                  be2_DC_NVT.norm_forces,
                  be2_DC_VarT.norm_forces,
    ...
    axes.legend(bbox_to_anchor=(0.55, 0.95), loc=2, borderaxespad=0.0,
                frameon=False)


    plt.savefig('zirilli_error_plot_BE_2.png', bbox_inches='tight')
